package com.boxoffice.hubservice.domain.hub.exception;
...
public enum HubErrorCode implements ErrorCode {
    ...
    CENTRAL_HUB_CANNOT_DELETE(HttpStatus.BAD_REQUEST, "HUB-030", "CENTRAL 허브는 삭제할 수 없습니다."),
    HUB_HAS_COMPANIES(HttpStatus.CONFLICT, "HUB-031", "소속 업체가 남아 있어 삭제할 수 없습니다.");
